...
def nms_rotated(boxes, scores, iou_threshold):
    ...
    The way the original datasets is annotated also matters. For example, if the datasets
    is a 4-point polygon datasets that does not enforce ordering of vertices/orientation,
