...
class TrainingSampler(Sampler):
    ...
    def __init__(self, size: int, shuffle: bool = True, seed: Optional[int] = None):
        """
        Args:
            size (int): the total number of data of the underlying datasets to sample from
...
class RepeatFactorTrainingSampler(Sampler):
    ...
    def __init__(self, dataset_dicts, repeat_thresh, shuffle=True, seed=None):
        """
        Args:
            dataset_dicts (list[dict]): annotations in Detectron2 datasets format.
    ...
    def _get_repeat_factors(self, dataset_dicts, repeat_thresh):
        ...
        Returns:
            torch.Tensor: the i-th element is the repeat factor for the datasets image
                at index i.
        """
    ...
    def _get_epoch_indices(self, generator):
        """
        Create a list of datasets indices (with repeats) to use for one epoch.
        ...
        Returns:
            torch.Tensor: list of datasets indices to use in one epoch. Each index
