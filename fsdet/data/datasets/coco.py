...
def load_coco_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    ...
    Args:
        ...
        extra_annotation_keys (list[str]): list of per-annotation keys that should also be
            loaded into the datasets dict (besides "iscrowd", "bbox",
...
def convert_to_coco_json(dataset_name, output_folder="", allow_cached=True):
    ...
    if os.path.exists(cache_path) and allow_cached:
        ...
        logger.info(f"Converting datasets annotations in '{dataset_name}' to COCO format ...)")
...
if __name__ == "__main__":
    """
    Test the COCO json datasets loader.
