...
def register_all_pascal_voc(root="datasets"):
    ...
    # register meta datasets
    METASPLITS = [
        ("ST_trainval_base1","ST2007","trainval","base1",1),
        ("ST_trainval_all1","ST2007","trainval","base_novel_1",1),
        ("ST_test_base1","ST2007","test","base1",1),
        ("ST_test_novel1","ST2007","test","base_novel_1",1),
        ("ST_test_all1","ST2007","test","base_novel_1",1),
        ...
        ("voc_2007_test_novel1", "VOC2007", "test", "base_novel_1", 1),
    ...
    for name, dirname, split, keepclasses, sid in METASPLITS:
        year = 2007 if (("2007" in name) or ("ST" in name))  else 2012
    ...
    # register fine-tune datasets with more base (3ploidy)
    WITH_MORE_BASE = []
    ploidy = 3
    for prefix in ["all", "novel"]:
        for sid in range(1, 2):
