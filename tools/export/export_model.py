...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-file", default="/home/lixu/Projects/PycharmProjects/FSCE-main/configurations/PASCAL_VOC/split1/2500shot_CL_IoU.yml", metavar="FILE", help="path to config file")
    parser.add_argument("--run-eval", action="store_true")
    parser.add_argument("--output", default="/home/lixu/Projects/PycharmProjects/FSCE-main/fsdet/output",help="output directory for the converted model")
    parser.add_argument(
        "opts",
