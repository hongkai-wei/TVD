...
for d in ["train", "val"]:
    DatasetCatalog.register("balloon_" + d, lambda d=d: get_balloon_dicts("/opt/FSCE-main/yytest/balloon/" + d))
    MetadataCatalog.get("balloon_" + d).set(thing_classes=["balloon"])
balloon_metadata = MetadataCatalog.get("balloon_train")
balloon_data = DatasetCatalog.get("balloon_train")
...
if __name__ == "__main__":
    ...
    args.config_file = "/opt/FSCE-main/configurations/COCO/R-101/base_training.yml"
