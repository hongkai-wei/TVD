...
def parse_args():
    ...
    # COCO arguments
    parser.add_argument('--coco', action='store_true', help='Use COCO datasets')
...
def get_config(seed, shot):
    ...
    if args.coco:
        ...
        config_dir = 'configurations/COCO-detection'
        ...
        config_dir = 'configurations/PascalVOC-detection'
